 ...
 * @author PC
 */
@WebServlet(urlPatterns = {"/BibliotecaServlet"})
public class BibliotecaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        modelLivro.setId(id);
        modelLivro.setNome(livro);
        modelLivro.setDataCriacao(data);

        daoLivro.insert(modelLivro);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h3> Esse livro " + livro + "</h3>");
            out.println("</body>");
            out.println("</html>");
        }
    }
